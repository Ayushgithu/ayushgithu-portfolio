        ...
        >
          ...
          >
            ...
            <p style={{ marginTop: 6, color: "#ccc" }}>
              Graduated B.Tech CSE student experienced in java, spring-boot, java fullstack development. Passionate about
              building impactful websites and seeking opportunities to contribute to
              real-world projects.
            </p>
          </motion.div>
        </motion.div>
        ...
        >
          ...
          <ul style={{ listStyle: "none", padding: 0, margin: 0, lineHeight: 1.8 }}>
            ...
            <li style={{ marginTop: 8 }}>
              ...
              , 2018-2021) <br />
              <span style={{ color: "#aaa" }}>Percentage: 78.10%</span>
            </li>
            <li style={{ marginTop: 8 }}>
              <strong>10th Board — D.A.V. High Secondary School</strong> (M.P. Board, 2018)
              <br />
              <span style={{ color: "#aaa" }}>Percentage: 77.6%</span>
            </li>
          </ul>
        </motion.div>
